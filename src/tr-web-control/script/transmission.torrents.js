...
transmission.torrents = {
	...
	fields: {
		...
		config: "id,name,downloadLimit,downloadLimited,peer-limit,seedIdleLimit,seedIdleMode,seedRatioLimit,seedRatioMode,uploadLimit,uploadLimited,sequential_download"
	},
